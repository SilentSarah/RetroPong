class InfoUser {
            ...
            <div class="user d-flex justify-content-between py-3 border-bottom border-secondary">
                <div class="user d-flex align-items-center gap-3">
                    <div class="d-flex" style=" width: 50px; height: 50px;position: relative;">
                        <img src="/static/img/general/frog.jpeg" alt="avatar" class="m-0 avatar w-100 h-100 rounded-circle" style="object-fit: cover;">
                ...
                <div>
                    ...
                    <img src="/static/img/chat/block.png" alt="icon" class="icon"  data-user-id='${user.id}'
    ...
    OnlineUsers(user) {
        ...
        <div class="user d-flex justify-content-between py-3 border-bottom border-secondary">
            <div class="user d-flex align-items-center gap-3">
                <div class="d-flex" style=" width: 50px; height: 50px;position: relative;">
                    <img src="/static/img/general/frog.jpeg" alt="avatar"
    ...
    PendingUsers(user) {
        ...
        <div class="icons">
            <img src="/static/img/chat/valide.png" alt="icon" class="icon"
                style="width: 31px;height: 31px;">
            <img src="/static/img/chat/remove.png" alt="icon" class="icon"
                style="width: 31px;height: 31px;">
        </div>
    </div>`
    }
    ...
    BlockUsers(user) {
        ...
        <img src="/static/img/chat/unblock_user.png" alt="icon" class="icon"
            style="width: 31px;height: 31px;">
    </div>`}
...
const fetch_info_user = async () => {
    const data = await Fetching('http://localhost:8000/info_user/2/','GET')
    ...
    if (all && online && pending && block) {
        all.innerHTML = "All friends: " + data.users.length
        online.innerHTML = "Online friends: " + data.users.length
