from ..models import *
import bcrypt, os, requests, re, json
    ...
    def get_user(user_id: int = -1, username: str = None) -> dict:
        ...
        try:
            ...
            user = {
                ...
                "profilepic": 'https://{}{}'.format(domain, user.uprofilepic.url if user.uprofilepic != "/static/img/pfp/Default.png" else "/static/img/pfp/Default.png") ,
                "profilebgpic": 'https://{}{}'.format(domain, user.uprofilebgpic.url if user.uprofilebgpic != "/static/img/pfp/DefaultBG.png" else "/static/img/pfp/DefaultBG.png") ,
                "desc": user.udesc,
                "ucids": user.ucids,
                "is42": user.uIs42,
        ...
        for user in users:
            ...
            try:
                if (user.uprofilepic.url.find("http") != -1):
                    ...
                    image = 'https://{}{}'.format(domain, user.uprofilepic.url if user.uprofilepic != "/static/img/pfp/Default.png" else "/static/img/pfp/Default.png")
            except:
